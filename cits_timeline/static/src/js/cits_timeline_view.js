odoo.define('cits_timeline.TimelineView', function (require) {
    ...
    const TimelineModel = require('cits_timeline.TimelineModel');
    const TimelineController = require('cits_timeline.TimelineController');
    const TimelineRenderer = require('cits_timeline.TimelineRenderer');
    const _lt = core._lt;
    ...
    var TimelineView = AbstractView.extend({
        ...
        icon: 'fa-clock-o',
        jsLibs: [
            '/cits_timeline/static/lib/js/vis.js'
        ],
        config: {
            Model: TimelineModel,
        ...
        init: function (viewInfo, params) {
            ...
            var mapping = {};
            var fieldNames = [];
            var displayFields = fields.display_name ? ['display_name'] : [];
